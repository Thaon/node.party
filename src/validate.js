...
export function isJSONValue(value, name = "unknown") {
...
export function isJSONObject(value, name) {
...
function validateJSONValue(value, path = "") {
  ...
  if (
    typeof value === "object" &&
    defined(global.p5) &&
    value.constructor === global.p5.Color
  ) {
    validationError = {
      path,
  ...
  if (
    typeof value === "object" &&
    defined(global.p5) &&
    value.constructor === global.p5.Vector
  ) {
    validationError = {
      path,
